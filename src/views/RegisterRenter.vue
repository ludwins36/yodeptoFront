        ...
        <div class="register-box">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    <p class="login-box-msg">Reg&iacute;strate como Inquilino</p>
                    ...
                    <div>
                        ...
                        <!-- <div class="row">
                            <div class="col-12">
                                <div class="g-recaptcha" :data-sitekey="recaptchaSiteKey" @verify="onCaptchaVerify"
                                    ref="recaptcha"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block"
                                    @click="submitForm()">Registrarme</button>
                            </div>
                        </div> -->
                        <div class="row">
